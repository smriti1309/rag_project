...
class IngestionService:
    ...
    def ingest_document(self, file: UploadFile, user_id: str) -> UploadResponse:
        """Upload file to Cloudflare R2, store metadata in Supabase DB, and run RAG pipeline for PDFs/TXTs.
        ...
        initial_status = "uploaded" if file_type in ("image", "docx") else "processing"
        ...
        # If PDF or TXT, run RAG ingestion pipeline using a temporary directory
        if file_type in ("pdf", "txt"):
            ...
            try:
                ...
                # Step 1: Parse (PDF parser or TXT)
                if file_type == "pdf":
